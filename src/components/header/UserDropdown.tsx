    ...
    <div className="relative">
      ...
      >
        {user?.profileImage && user.profileImage !== "#" && user.profileImage !== "/images/user/owner.jpg" ? (
          ...
          <div className="mr-3 flex h-11 w-11 shrink-0 items-center justify-center rounded-full bg-brand-500 text-sm font-bold text-white shadow-xs">
      ...
      >
        ...
        <ul className="flex flex-col gap-1 pt-4 pb-3 border-b border-gray-200 dark:border-gray-800">
          <li>
            ...
            >
              {/* Keep your existing Edit Profile SVG here */}
              Edit profile
            </DropdownItem>
          </li>
          ...
          <li>
            <DropdownItem
              ...
              className="flex items-center gap-3 px-3 py-2 font-medium text-gray-700 rounded-lg group text-theme-sm hover:bg-gray-100 hover:text-gray-700 dark:text-gray-400 dark:hover:bg-white/5 dark:hover:text-gray-300"
            >
              {/* Keep your existing Account Settings SVG here */}
              Account settings
            </DropdownItem>
          </li>
          ...
          <li>
            <DropdownItem
              ...
              className="flex items-center gap-3 px-3 py-2 font-medium text-gray-700 rounded-lg group text-theme-sm hover:bg-gray-100 hover:text-gray-700 dark:text-gray-400 dark:hover:bg-white/5 dark:hover:text-gray-300"
            >
              {/* Keep your existing Support SVG here */}
              Support
            </DropdownItem>
          </li>
        </ul>
